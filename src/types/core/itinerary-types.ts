...
import { Place, CategoryName } from './base-types'; // Import CategoryName
import { RouteData } from './route-data';

// Place with time information
export interface ItineraryPlaceWithTime {
  id: string;                   // Unique identifier for this itinerary entry (MUST BE STRING)
  name: string;                 // Name of the place
  category: string;             // Category of the place, can be CategoryName or other strings like "교통"
