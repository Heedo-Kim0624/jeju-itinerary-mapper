// ✅ 리팩터링된 PlaceDetailsPopup.tsx (LeftPanel 용)
...
const PlaceDetailsPopup: React.FC<PlaceDetailsPopupProps> = ({ place, onClose }) => {
  return (
    <Card className="absolute top-4 left-1/2 -translate-x-1/2 w-[90%] md:w-[360px] z-50 shadow-xl border border-gray-300 bg-white">
